...
elseif(CUSTOM_MEMORYCHECK_TYPE STREQUAL "HELGRIND")
      ...
      set(MEMORYCHECK_COMMAND_OPTIONS "--tool=helgrind --history-level=full --conflict-cache-size=10000000")
       string(APPEND MEMORY_CHECK_COMMAND_OPTIONS " --xml=yes --xml-file=${CMAKE_BINARY_DIR}/helgrind/\${REPLACE_TEST_NAME}.xml")
else()
      message(FATAL_ERROR "CUSTOM_MEMORYCHECK_TYPE Support MEMCHECK or HELGRIND")
endif()
string(APPEND MEMORY_CHECK_COMMAND_OPTIONS " --error-limt=no --max-threads=20 --max-stackframe=20000000 --main-stacksize=8000000 --num-callers=20")
