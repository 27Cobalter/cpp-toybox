...
if(NOT CMAKE_CXX_COMPILER_ID MATCHES "MSVC") # GNU or Clang
      if (CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|amd64)$")
            string(APPEND CMAKE_CXX_FLAGS " -march=x86-64-v3 -fcf-protection=full")
      elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64)$")
            string(APPEND CMAKE_CXX_FLAGS " -march=armv8-a -mbranch-protection=standard")
      endif()
...
if(NOT MSVC) # GNU like
      string(APPEND CMAKE_CXX_FLAGS " -fvisibility=hidden -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -Wl,-Bsymbolic")
      ...
      string(APPEND CMAKE_CXX_FLAGS_RELEASE " -g0 -fno-stack-clash-protection -fno-stack-protector -fomit-frame-pointer -foptimize-sibling-calls -fcommon -flto=auto -s -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=0")
