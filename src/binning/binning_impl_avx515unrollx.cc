...
template void Binning<Impl::Avx512UnrollX>::Execute<2, 2>(const cv::Mat&, cv::Mat&);
template void Binning<Impl::Avx512UnrollX>::Execute<4, 4>(const cv::Mat&, cv::Mat&);
...
template <>
template <>
void Binning<Impl::Avx512UnrollX>::Execute<1, 1>(const cv::Mat& src, cv::Mat& dst) {
...
void Binning<Impl::Avx512UnrollX>::Execute(const cv::Mat& src, cv::Mat& dst) {
