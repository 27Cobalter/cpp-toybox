...
template void Binning<Impl::Avx512UnrollX>::Execute_Impl<2, 2>(const cv::Mat&, cv::Mat&);
template void Binning<Impl::Avx512UnrollX>::Execute_Impl<4, 4>(const cv::Mat&, cv::Mat&);
