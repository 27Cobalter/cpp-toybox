...
template void Binning<Impl::Avx512Seq>::Execute_Impl<2, 2>(const cv::Mat&, cv::Mat&);
template void Binning<Impl::Avx512Seq>::Execute_Impl<4, 4>(const cv::Mat&, cv::Mat&);
...
template <>
template <>
void Binning<Impl::Avx512Seq>::Execute_Impl<1, 1>(const cv::Mat& src, cv::Mat& dst) {
...
void Binning<Impl::Avx512Seq>::Execute_Impl(const cv::Mat& src, cv::Mat& dst) {
