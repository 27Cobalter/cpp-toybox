...
TEST_F(Overflow, CalcV_Avx512) {
  ...
  auto result =
      profiler.CalcV_Impl<VHAdd::Method::AVX512>(sptr, src.total(), 0, 0, src.cols, src.rows);
...
TEST_F(Overflow, CalcH_Avx512) {
  ...
  auto result =
      profiler.CalcH_Impl<VHAdd::Method::AVX512>(sptr, src.total(), 0, 0, src.cols, src.rows);
...
TEST_F(Overflow, CalcVH_Avx512) {
  ...
  auto [result_v, result_h] =
      profiler.CalcVH_Impl<VHAdd::Method::AVX512>(sptr, src.total(), 0, 0, src.cols, src.rows);
